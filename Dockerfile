...
RUN yum --enablerepo=epel,remi,remi-php72 -y install supervisor php php-cli php-common php-devel php-gd php-json php-mbstring php-mcrypt php-mysqlnd php-opcache php-pdo php-pear php-pecl-apcu php-pecl-imagick php-pecl-redis php-pecl-uuid php-pecl-xdebug php-pecl-yaml php-pecl-zip
